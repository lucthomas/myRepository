...
public class Flower
{
    ...
    */
    ...
    {
        // TODO
        Ellipse fCircle = new Ellipse(x,y,20,20);
        fCircle.setColor(Color.PINK);
        fCircle.fill();
        
        Ellipse sCircle = new Ellipse(x,y+20,20,20);
        sCircle.setColor(Color.YELLOW);
        sCircle.fill();
        
        Ellipse tCircle = new Ellipse(x+20,y+20,20,20);
        tCircle.setColor(Color.PINK);
        tCircle.fill();
        
        Ellipse foCircle = new Ellipse(x-20,y+20,20,20);
        foCircle.setColor(Color.PINK);
        foCircle.fill();
        
        Ellipse fiCircle = new Ellipse(x,y+40,20,20);
        fiCircle.setColor(Color.PINK);
        fiCircle.fill();
        
        Line stem = new Line(x+10,y+60,x+10,y+110);
